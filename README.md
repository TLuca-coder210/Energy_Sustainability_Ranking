...
*   **Loss Function:** Binary Cross-Entropy (BCE) Loss at pixel level:
...
3.  **Numerical Integration:** Fit a continuous function $E(t)$ using regression and calculate total daily energy yield ($E_{\text{total}}$) via integration:
